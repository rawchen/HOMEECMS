...
<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        ...
        </i><a href="${pageContext.request.contextPath}/admin_index.jsp">首页</a>
    ...
    <div class="result-wrap">
        <div class="result-content">
            <form action="${pageContext.request.contextPath}/updateUserListServlet?userId=${u.user_id}" enctype="multipart/form-data" method="post" id="myform" name="myform">
