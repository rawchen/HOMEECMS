    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="${pageContext.request.contextPath}/userListByKeyServlet" method="post">
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <c:forEach var="u" items="${pb.list}">
	                        <tr>
	                            ...
	                            <td>
	                                <a class="link-update" href="${pageContext.request.contextPath}/toupdateUserListServlet?id=${u.user_id}">修改</a>

                                    <c:if test="${u.user_name !='admin' }">
                                        <a class="link-del" href="javascript:Delete('你确定要删除用户【${u.user_name}】吗？', '${pageContext.request.contextPath}/delUserByIdServlet?id=${u.user_id}')">删除</a>
                                    </c:if>
