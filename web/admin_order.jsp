    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="${pageContext.request.contextPath}/orderListByKeyServlet" method="post">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <c:if test="${'1'==o.is_pay && '0'==o.is_ship && '0'==o.is_receipt}">
                                        <a class="link-update" href="javascript:Delete('你确定订单号为${o.order_id}的货物发货吗？','updateOrderIsShipServlet?oid=${o.order_id}')">点击发货</a>
                                    </c:if>
                        ...
                        <c:forEach var="o" items="${orders}">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <c:if test="${'1'==o.is_pay && '0'==o.is_ship && '0'==o.is_receipt}">
                                        <a class="link-update" href="updateOrderIsShipServlet?oid=${o.order_id}">点击发货</a>
                                    </c:if>
