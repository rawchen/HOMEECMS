                    ...
                    <table class="result-tab" width="86%">
                        ...
                        <c:forEach var="cate" items="${catelist}">
                        	 ...
                        	 <c:if test="${cate.category_parentid == 0 }">
		                        <tr style="line-height:20px; background-color: #d8eaff">
		                        	<td>${cate.category_id }</td>
		                        	<td>|-${cate.category_name }</td>
		                        	<td><a href="${pageContext.request.contextPath}/toUpdateCategoryServlet?cid=${cate.category_id }">修改</a> <a href="javascript:catedel(${cate.category_id })">删除</a></td>
