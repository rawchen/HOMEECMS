...
Source Server         : 119.23
Source Server Version : 50561
Source Host           : 119.23.60.193:3306
Source Database       : homeecms

Target Server Type    : MYSQL
Target Server Version : 50561
File Encoding         : 65001

Date: 2020-10-13 11:32:20
*/
...
CREATE TABLE `tb_order` (
  ...
  `user_id` int(5) DEFAULT NULL,
  `order_price` int(5) DEFAULT NULL,
  `order_time` datetime DEFAULT NULL,
  `is_pay` varchar(10) DEFAULT NULL,
  `is_ship` varchar(10) DEFAULT NULL,
  `is_receipt` varchar(10) DEFAULT NULL,
...
CREATE TABLE `tb_product` (
  ...
  `product_name` varchar(128) DEFAULT NULL,
  `product_info` varchar(512) DEFAULT NULL,
  `product_price` int(10) DEFAULT NULL,
  `product_stock` int(10) DEFAULT NULL,
  `product_fid` int(5) DEFAULT NULL,
  `product_cid` int(5) DEFAULT NULL,
  `product_photo` varchar(50) DEFAULT NULL,
  `product_style` varchar(50) DEFAULT '0',
  `product_sales` int(5) DEFAULT '0',
...
CREATE TABLE `tb_user` (
  ...
  `user_nickname` varchar(50) DEFAULT '未知昵称',
  `user_password` varchar(20) NOT NULL,
  `user_sex` varchar(20) DEFAULT NULL,
  `user_vip` varchar(20) DEFAULT NULL,
  `user_viptime` varchar(60) DEFAULT NULL,
  `user_status` varchar(10) DEFAULT NULL,
  `user_photo` varchar(30) DEFAULT '0.jpg',
...
INSERT INTO `tb_user` VALUES ('8', '111', '无昵称哦', '11', null, '0', '0', '1', null);
INSERT INTO `tb_user` VALUES ('9', 'asd', '失眠', 'asd', '女', '0', '0', '1', '9.png');
INSERT INTO `tb_user` VALUES ('10', '123', '无昵称哦', '123', null, '0', '0', '1', null);
INSERT INTO `tb_user` VALUES ('11', '123456', '无昵称哦', '123', null, '0', '0', '1', '11.png');
INSERT INTO `tb_user` VALUES ('12', '11', '无昵称哦', '122', null, '0', '0', '1', null);
